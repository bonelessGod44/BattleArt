...
define('CONTACTFORM_FROM_ADDRESS', 'battleart@gmail.com');
define('CONTACTFORM_FROM_NAME', 'Contact Form on battleart.com');
...
define('CONTACTFORM_TO_ADDRESS', 'battleart@gmail.com');
define('CONTACTFORM_TO_NAME', 'BattleArt');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'battleart@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'BattleArt92077');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6LdX3O8rAAAAALAUxadeDgJwRONGbtwczS5uEYA7');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6LdX3O8rAAAAAHwBIDwcfk-CT0Rdkv9OKQBG4cJJ');
